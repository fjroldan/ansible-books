...
# 1.1.1.2
sudo sh -c 'printf "install squashfs /bin/true
...
# 1.1.1.3
# Este filesystem es necesario en Azure
...
# 1.2.4
(cat /etc/yum.repos.d/rh-cloud-rhel8-eus.repo) > package-manager-config.txt
...
# 5.6.3
sudo bash -c 'printf "readonly TMOUT=900 ; export TMOUT" >> /etc/profile.d/timeout.sh'
...
# FIN
echo "Criterios CIS de RHEL 8.4 fueron aplicados."
